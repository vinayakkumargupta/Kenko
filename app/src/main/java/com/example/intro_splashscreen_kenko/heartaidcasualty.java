...
public class heartaidcasualty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heartaidcasualty);

        user = "RAMESH SUMESH";
        btn1 = findViewById(R.id.button7);
        t1 = findViewById(R.id.text3);
        t2 = findViewById(R.id.text_trial);
        flp = LocationServices.getFusedLocationProviderClient(heartaidcasualty.this);
        if (ContextCompat.checkSelfPermission(heartaidcasualty.this, Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(heartaidcasualty.this, new String[]{Manifest.permission.CALL_PHONE}, permission);
        }

        if (ActivityCompat.checkSelfPermission(heartaidcasualty.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(heartaidcasualty.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            getCurrentLocation();
        } else {
            ActivityCompat.requestPermissions(heartaidcasualty.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, permission);
        }
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent passi1 = new Intent(heartaidcasualty.this, finalact_heart_aid.class);
